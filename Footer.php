    ...
    <style>
        * {
        ...
        .footer {
            ...
            color: white;
            position: relative; /*dont remove this, it makes teh footer visible at the bottom */
            overflow: hidden; /* dont removethis, it prevents the layout of calendar and footer from collliding */
        ...
        .footer::before {
            ...
            position: absolute;
            inset: 0;   
            background: linear-gradient(rgba(0, 0, 0, 0.55), rgba(0, 0, 0, 0.83)), url('./imgs/teacher.jpg');
...
<body>
    <footer class="footer">
        <div class="container">
            <div class="school-info" style="background-color: #282c3c9c;
                    border-radius: 2pc;
                    padding: 1em;
                    height: 20em;
                    align-items: center;
                ...
                <div class="school-name">
                    <img src="./imgs/logo.jpg" alt="Lucena South II Elementary School Logo" style="width: 61px; height: auto; border-radius: 70%; margin-right: 10px;">
                    Lucena South II Elementary School
                </div>
                <p class="school-description">
                    We provide a safe and nurturing environment where students grow academically and personally. Our dedicated teachers foster discipline, curiosity, and lifelong learning, helping every child become a confident and responsible individual.
                </p>
            </div>
